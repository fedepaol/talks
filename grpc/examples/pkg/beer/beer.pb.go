...
type BeerErrorCode int32

const (
	BeerErrorCode_UNKNOWN        BeerErrorCode = 0
	BeerErrorCode_INVALID_BEER   BeerErrorCode = 1
	BeerErrorCode_BEER_NOT_FOUND BeerErrorCode = 2
)

var BeerErrorCode_name = map[int32]string{
	0: "UNKNOWN",
	1: "INVALID_BEER",
	2: "BEER_NOT_FOUND",
}

var BeerErrorCode_value = map[string]int32{
	"UNKNOWN":        0,
	"INVALID_BEER":   1,
	"BEER_NOT_FOUND": 2,
}

func (x BeerErrorCode) String() string {
	return proto.EnumName(BeerErrorCode_name, int32(x))
}

func (BeerErrorCode) EnumDescriptor() ([]byte, []int) {
...
type BeerError struct {
	Reason               BeerErrorCode `protobuf:"varint,1,opt,name=reason,proto3,enum=BeerErrorCode" json:"reason,omitempty"`
...
func (m *BeerError) Reset()         { *m = BeerError{} }
func (m *BeerError) String() string { return proto.CompactTextString(m) }
func (*BeerError) ProtoMessage()    {}
func (*BeerError) Descriptor() ([]byte, []int) {
	return fileDescriptor_3f9c2065d50c4def, []int{4}
}

func (m *BeerError) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_BeerError.Unmarshal(m, b)
}
func (m *BeerError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_BeerError.Marshal(b, m, deterministic)
}
func (m *BeerError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BeerError.Merge(m, src)
}
func (m *BeerError) XXX_Size() int {
	return xxx_messageInfo_BeerError.Size(m)
}
func (m *BeerError) XXX_DiscardUnknown() {
	xxx_messageInfo_BeerError.DiscardUnknown(m)
}

var xxx_messageInfo_BeerError proto.InternalMessageInfo

func (m *BeerError) GetReason() BeerErrorCode {
	if m != nil {
		return m.Reason
	}
	return BeerErrorCode_UNKNOWN
}

func (m *BeerError) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
...
func init() {
	proto.RegisterEnum("BeerErrorCode", BeerErrorCode_name, BeerErrorCode_value)
	...
	proto.RegisterType((*BeerError)(nil), "BeerError")
}
...
var fileDescriptor_3f9c2065d50c4def = []byte{
	...
	,
}
